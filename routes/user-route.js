...
router.get('/history/:email', user_controller.getCheckInHistory, user_controller.getEventHistory, user_controller.getPointReqs, user_controller.getPointHistory);
